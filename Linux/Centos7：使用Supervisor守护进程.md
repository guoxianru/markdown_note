...
### 6、访问Supervisor的图形化界面

- 修改配置

将supervisord.conf 中的一段配置更改如下

![Centos7：使用Supervisor守护进程配置](Centos7：使用Supervisor守护进程配置.png "Centos7：使用Supervisor守护进程配置")
...
在访问其web管理界面之前，先需要配置的端口，这里分配是9001端口,下面是端口管理的一些命令
...
![Centos7：使用Supervisor守护进程端口](Centos7：使用Supervisor守护进程端口.png "Centos7：使用Supervisor守护进程端口")

- 访问图形界面

端口开启成功后访问supervisor的界面程序进行进程管理

![Centos7：使用Supervisor守护进程界面](Centos7：使用Supervisor守护进程界面.png "Centos7：使用Supervisor守护进程界面")
